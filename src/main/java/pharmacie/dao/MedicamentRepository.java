...
public interface MedicamentRepository extends JpaRepository<Medicament, Integer> {
   ...
   * ceux dont le stock est inférieur ou égal au niveau de réapprovisionnement
   * et qui ne sont pas indisponibles
   */
  @Query("""
        SELECT m FROM Medicament m
      ...
      """)
  List<Medicament> aReaprovisionner();

  /**
   * Trouve les fournisseurs susceptibles de réapprovisionner ces médicaments
